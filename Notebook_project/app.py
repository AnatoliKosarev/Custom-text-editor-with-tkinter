...
def check_for_changes():
    ...
    elif name[-1] == '*':  # if the text is the same and there is * in tab name - remove it
...
def show_about():
    messagebox.showinfo(
        title='About',
        message='Custom editor is a simple tabbed text editor designed to help learn Tkinter.'
    )
